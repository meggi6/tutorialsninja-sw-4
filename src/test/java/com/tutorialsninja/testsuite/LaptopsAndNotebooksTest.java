...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        checkOutPage.enterFirstName("anil");
        checkOutPage.enterLastName("kumar");
        checkOutPage.enterEmail("anilkumar123@gmail.com");
        checkOutPage.enterPhoneNumber("4478365766145");
        checkOutPage.enterAddress1("Lewes Road");
        checkOutPage.enterCity("Finchley");
        checkOutPage.enterPostCode("N12 9nh");
